...
#QPA by semester
#Factor semester and create levels to solve ordering issue (e.g., F16 comes before S15)
...
basic_grade_df$semester = factor(basic_grade_df$semester, levels = reference_level)
...
#Can backtrack to try to find them (difficult)
