...
add_prereq = function(input_df, prereq_to_add,
                       replace_name = prereq_to_add[1], grade_to = "T",
...
Outcome: Distribution of grades 
Question: How would we check accuracy on test set if outcome is distribution? Wouldn't it have to be definitive like A B or at least an E(Distribution) like 3.35?
...
model_df_func(response_course = 36402, predictor_courses = c(21256, 36401))
```
