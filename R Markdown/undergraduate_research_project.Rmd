...
#title = div(tags$img(src = "cmu-stat-ds.png", alt = "Error", deleteFile = F), "Stat and DS Advising"), #add image (bug: not locating image file)

top_four_outcome_pred = c(36402, 36401, 73374, 15351)

top_four_retake = first_leg %>% head(4) %>% pull(1)

ui =  navbarPage(title = "Stat and DS Advising",
